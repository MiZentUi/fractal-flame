...
watch(requesState, console.log)

const TRIGGER = () => {fractalsApi.generation(requesState).then(console.log)}
...
<template>
    <div class="bg-transparent sticky min-h-screen w-full">
        <ButtonGroup class="fixed z-50 bottom-16 right-4">
            <Button variant="outline" class="w-50 align-middle" @click="TRIGGER"> GENERATE </Button>
